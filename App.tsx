              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                ...
                <div className="bg-gradient-to-br from-blue-700 via-cyan-600 to-emerald-500 text-white p-8 rounded-3xl shadow-2xl hover:shadow-cyan-300/40 transition-all duration-500 relative overflow-hidden group">
                  ...
                  <div className="space-y-4 text-indigo-50">
                    ...
                    <p><strong>Leitura teórica inspirada na Psicanálise:</strong> {STYLE_DETAILS[result.primary].psycho}</p>
                  </div>
                </div>
...
<div className="bg-gradient-to-br from-purple-50 via-white to-purple-50 border border-purple-200 rounded-3xl p-6 mb-6 shadow-lg hover:shadow-2xl hover:-translate-y-1 hover:scale-[1.01] transition-all duration-300 group">

  <div className="flex items-start gap-5">

    <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-500 to-purple-700 text-white flex items-center justify-center text-3xl shadow-lg group-hover:scale-110 transition-transform duration-300">
      👥
    </div>
    ...
    <div className="flex-1">
      ...
      <h6 className="text-3xl font-bold text-slate-800 mt-1 group-hover:text-purple-700 transition-colors">
      ...
      <p className="text-slate-500 italic mt-2 leading-relaxed">
        Os relacionamentos sociais fortalecem o sentimento de pertencimento, cooperação e convivência. Eles influenciam nossa confiança, autoestima e participação na comunidade.
      </p>

      <div className="w-16 h-1 bg-purple-500 rounded-full my-4 group-hover:w-24 transition-all duration-300"></div>
...
<div className="bg-gradient-to-br from-rose-50 via-white to-rose-50 border border-rose-200 rounded-3xl p-6 mb-6 shadow-lg hover:shadow-2xl hover:-translate-y-1 hover:scale-[1.01] transition-all duration-300 group">
 ...
 <div className="bg-gradient-to-br from-orange-50 via-white to-orange-50 border border-orange-200 rounded-3xl p-6 mb-6 shadow-lg hover:shadow-2xl hover:-translate-y-1 hover:scale-[1.01] transition-all duration-300 group">

  <div className="flex items-start gap-5">

    <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-orange-500 to-orange-700 text-white flex items-center justify-center text-3xl shadow-lg group-hover:scale-110 transition-transform duration-300">
      👨‍👦
    </div>
    ...
    <div className="flex-1">
      ...
      <h6 className="text-3xl font-bold text-slate-800 mt-1 group-hover:text-orange-700 transition-colors">
      ...
      <p className="text-slate-500 italic mt-2 leading-relaxed">
        A parentalidade envolve cuidado, responsabilidade, diálogo e construção de vínculos seguros, favorecendo o desenvolvimento saudável das relações familiares.
      </p>

      <div className="w-16 h-1 bg-orange-500 rounded-full my-4 group-hover:w-24 transition-all duration-300"></div>
